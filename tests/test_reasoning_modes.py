...
class ReasoningModeTests(unittest.TestCase):
    ...
    def test_final_real_request_uses_responses_and_normalizes(self):
        ...
        class Response:
            # post_json_url reads Content-Type to tell a JSON body from an HTML error page;
            # a real http.client.HTTPResponse always carries .headers, so the double must too.
