...
# Five decibels quieter than they were. These sat loud enough to compete with the narration;
# a cut sound is punctuation, not a voice. Everything moved together so the mix keeps its
# internal balance - a click stays below a whoosh, a whoosh below an impact.
CAT_DB = {
    "bright_whoosh": -13, "swipe_whoosh": -12, "whoosh_hit_combo": -11, "impact_hit": -10,
    "low_impact": -13, "caption_pop": -17, "ui_click": -20, "notification_ding": -17,
    "idea_reveal": -17, "camera_flash": -14, "flash_blink": -16, "school_bell": -18,
    "payment_ding": -18, "message_sent": -18,
}
